...
if ("undefined" != typeof g_MinimalDownload && g_MinimalDownload && (window.location.pathname.toLowerCase()).endsWith("/_layouts/15/start.aspx") && "undefined" != typeof asyncDeltaManager) {
    ...
    RegisterModuleInit("CandCProjectSite.js", JavaScript_Embed); //MDS registration
...
function JavaScript_Embed() {
    ...
    loadScript(jQuery, function () {
        $(document).ready(function () {
            var message = "This site is shared with external users - please use the PRIVATE library for internal-only documents!"
